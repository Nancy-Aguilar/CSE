...
NURSE = Room("Nurse's Room", "You are inside the Nurse's room and facing east is the Nurse's room and facing North in "
                             "the lounge room and facing West if the office", 'LOUNGE', None, None, 'OFFICE')
...
DORMS1 = Room("Dorms for 1st years", "You are inside the dorm building, all the rooms are closed and facing North are "
                                     "the 2nd year dorms", 'DORMS2', None, 'CT3', None)

DORMS2 = Room("Dorms for 2nd years", "You are inside the dorm building, all the rooms are closed and facing North are "
                                     "the 3rd year dorms", 'DORMS3', 'DORMS1', None, None)
DORMS3 = Room("Dorms for 3rd years", "You are inside the dorm building, all the rooms are closed and facing North are "
                                     "the 4th year dorms", 'DORMS4', 'DORMS2', None, None)

DORMS4 = Room("Dorms for 4th years", "You are inside the dorm building, all the rooms are closed and facing North is "
...
CREATION = Room("Creation Table", "You're standing in front of a table that has four potions, you can create anything "
                ...
                'WEAPON', None)
WEAPON = Room("Weapon Room", "You're inside the weapon room, there are some swords on the ground and there is an "
...
CP1 = Room("Cave Place #1", "You're inside the cave and people say that there are many dangerous things inside "
