...
PTR = ("Power Training Room", "You're in the power training room and there is a station for creating items up North "
                              "and facing East is the weapon room", 'CREATION', 'DORMS4', 'WEAPON', None)
CREATION = ("Creation Table", "You're standing in front of a table that has four potions, you can create anything you "
