...
def caveplace2():
    ...
    time.sleep(1)
    print("You: I should continue looking for the tree")
...
class Character(object):
    ...
    def cut(self):
        print("You cut with the weapon")

    def shoot(self):
        print("You shoot with the weapon")
...
while True:
    ...
    if player.location == CP1 and player.first_time_CP1 is False:
        print(player.location.name)
        print("There's a light leading East, South, and West is the Weapon room")
    ...
    if command in directions:
        ...
        if Sword in player.inventory:
            ...
            print("You don't have a weapon to cut with")

    elif 'shoot' in command:
        if BowArrow in player.inventory:
            player.shoot()
        else:
            print("You don't have a weapon to shoot with")
