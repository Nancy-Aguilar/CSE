...
class Character(object):
    ...
    def attack(self, target):
        if self.alive:
            print("You attack the %s. The Nirad's health is %d." % (target.name, target.health))
...
while True:
    ...
    if player.location == CP2 and player.first_time_CP2 is True and Sword in player.inventory:
        caveplace3()
        time.sleep(0)
        player.first_time_CP2 = False

    if player.location == CP2 and player.first_time_CP2 is True and BowArrow in player.inventory:
        caveplace3()
        time.sleep(0)
        player.first_time_CP2 = False
    ...
    if player.location == CP2 and player.attack:
        nirad.health = 100
        nirad.health -= 100
        if nirad.health == 0:
            print("Nirad is dead")
    ...
    if player.location == CP5 and player.attack:
        nirad.health = 100
        nirad.health -= 100
        if nirad.health == 0:
            print("Nirad is dead")
    ...
    if player.location == CP8 and player.attack:
        nirad.health = 100
        nirad.health -= 100
        if nirad.health == 0:
            print("Nirad is dead")
    ...
    if player.location == CP9 and player.attack:
        nirad.health = 100
        nirad.health -= 100
        if nirad.health == 0:
            print("Nirad is dead")
    ...
    if player.location == CP11 and player.attack:
        nirad.health = 100
        nirad.health -= 100
        if nirad.health == 0:
            print("Nirad is dead")
    ...
    if player.location == CP4 and player.first_time_CP12 is False:
        caveplace2()
        print(player.location.name)
        print(player.location.description)
    ...
    if player.location == CP13 and player.attack:
        nirad.health = 100
        nirad.health -= 100
        if nirad.health == 0:
            print("Nirad is dead")
    ...
    if player.location == CP15 and player.attack:
        nirad.health = 100
        nirad.health -= 100
        if nirad.health == 0:
            print("Nirad is dead")
